        ...
        <div className="w-full">
            ...
            <div className="flex justify-between items-center flex-row mt-3">
                <div className="ml-24 flex gap-3 ">
                    <p>Sort : </p>
                    <p onClick={toggleSortBy} className="hover:cursor-pointer hover:text-popover flex items-center gap-3">{sortBy} {sortBy === 'Oldest' ? <IoArrowUp/> : <IoArrowDown/>}</p>
                </div>
                <div className="hover:cursor-pointer hover:text-popover mr-7" onClick={() => setIsCommentVisible(!isCommentVisible)}>
            ...
            <div className="mt-4 ml-20 bg-primary rounded-md ">
                ...
                <Button className="button bg-popover-foreground m-2" onClick={handleSafe}>Safe</Button>
                <Button className="button bg-popover-foreground m-2" onClick={handleSubmit}>Submit</Button>
                </div>
                </div>
            </div>
            )}
